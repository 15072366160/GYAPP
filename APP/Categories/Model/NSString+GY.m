...
@implementation NSString (GY)

//#pragma mark - 获取设备当前网络IP地址
//+ (void)getNetworkIP:(BKDictionaryBlock)block {
//    
//    [GYNetworking requestMode:NetModeGET header:nil url:@"http://ip.taobao.com/service/getIpInfo.php" params:@{@"ip":@"myip"} success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable data) {
//
